...
async function main() {
  ...
  const americano = await axios.post('/products', {
    user: sinan,
    name: 'Americano',
    category: 'Drink',
    subCategory: 'Coffee',
  ...
  const latte = await axios.post('/products', {
    user: sinan,
    name: 'Latte',
    category: 'Drink',
    subCategory: 'Coffee',
  ...
  const chocolateLatte = await axios.post('/products', {
    user: sinan,
  ...
  const coffeeBean = await axios.post('/raw-materials', {
    user: sinan,
    name: 'Coffee Bean',
    category: 'Drink',
    subCategory: 'Coffee',
  ...
  const milk = await axios.post('/raw-materials', {
    user: sinan,
    name: 'Milk',
    category: 'Drink',
    subCategory: 'Coffee',
  ...
  const syrup = await axios.post('/raw-materials', {
    user: sinan,
    name: 'Syrup',
    category: 'Drink',
    subCategory: 'Coffee',
